...
export function CTASection() {
  return (
    <motion.section
      ...
      className="bg-primary py-section-gap-mobile md:py-section-gap"
    >
      <motion.div variants={fadeInUp} className="max-w-container-max mx-auto px-margin-mobile md:px-gutter text-center flex flex-col items-center">
